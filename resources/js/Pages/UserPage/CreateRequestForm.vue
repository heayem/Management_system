                ...
                <div class="grid grid-cols-2   gap-4">
                    ...
                    <div>
                        ...
                        <div class="card flex justify-content-center">
                            <Dropdown v-model="form.department_Id" :options="departments" optionLabel="name" placeholder="Select your department"
                                class="w-full" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="card flex justify-content-center">
                            <Dropdown v-model="form.type" :options="type" optionLabel="name" placeholder="Select Leave/ Mission"
                                class="w-full" />
                        </div>
