                    ...
                    <Column v-for="col in columns" :field="col.field" :header="col.header">
                        <template #body="{ data }">
                            ...
                            <div v-else-if="col.header == 'Permission' && col.header !== ''">
                                <p v-if="data[col.field]===0"> No permission </p>
                                <p v-if="data[col.field]===1"> Can approve missio </p>
                                <p v-if="data[col.field]===2"> Can approve leave </p>
                                <p v-if="data[col.field]===3"> Can approve leave & mission </p>
                            </div>
